...
function createContactsByLetterHTML(contactsByLetter, contact) {
              ...
              <div class="contacts_list row-center">
                <div class="">
                  <div class="contacts_circle">
                    <a class="contacts_circle_in row-center-center font400 contact-initial-background" style="background-color: ${contact.color};">${contact.name.charAt(0).toUpperCase()}${contact.name.split(' ')[1].charAt(0).toUpperCase()}</a> 
                  </div>
                </div>
                <div class="contact_container_info column-flex-start">
                  <a class="contact_name_info font400" id="smallContactName">${contact.name}</a> 
                  <a class="contact_mail_info font400" id="smallContactPhone">${contact.email}</a> 
                </div>
              </div>
            `).join('')}
          </div>
    ...
    const contactInitialBackgrounds = document.querySelectorAll('.contact-initial-background');
...
function renderBigCardContact(contact) {
    ...
    <div class="contacts_display_name row-center">
        <div class="contacts_init_circle row-center-center" style="background-color: ${contactColor}">
            <a class="contacts_initials font400">${contactName.charAt(0).toUpperCase()}${contactName.split(' ')[1].charAt(0).toUpperCase()}</a>
        </div>
